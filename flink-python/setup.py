    ...
    for src_path in src_paths:
        if os.path.isdir(src_path):
            ...
            for child_file in child_files:
                copy(os.path.join(src_path, child_file), output_directory)
        else:
            copy(src_path, os.path.join(output_directory, os.path.basename(src_path)))
    ...
    for file_element in file_elements:
        ...
        try:
            ...
            if dst == output_directory:
                extracted_file_paths.append(os.path.join(base_dir, source))
        except IndexError:
            pass
