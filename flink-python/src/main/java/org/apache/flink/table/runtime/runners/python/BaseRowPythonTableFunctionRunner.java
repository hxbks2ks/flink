 ...
 */
public class BaseRowPythonTableFunctionRunner extends AbstractPythonTableFunctionRunner<BaseRow, BaseRow> {
	...
	public TypeSerializer<BaseRow> getInputTypeSerializer() {
		return (BaseRowTableSerializer) PythonTypeUtils.toBlinkTableTypeSerializer(getInputType());
	}

	@Override
	public TypeSerializer<BaseRow> getOutputTypeSerializer() {
		return (BaseRowTableSerializer) PythonTypeUtils.toBlinkTableTypeSerializer(getOutputType());
	}
}
